...
3. DOOH (Digital-Out-of-Home) Inventory already contains creative content from the media plan campaign that is running or has been sent to the playlist ([See Sent Creative to Playlist ↗](/documentation/campaign-management/create/media-plan/creatives/sent-to-playlist)).
...
![Playlist Order Overview](/images/documentation/operational/playlist-order/overview/playlist-order-overview.png)
...
You can change the order of the playlist using the sort playlist button ([See Change Playlist Order ↗](/documentation/operational/playlist-order/change))

![ Sort Playlist Button](/images/documentation/operational/playlist-order/overview/playlist-order-sort-button.png)
