...
<Steps>
      ...
      <Step title="Duration (Required)">
            <Info>
                  The selected campaign duration will be used when you filter the Campaign Report page. The date range that will be active as a filter on the campaign report page is the range of the campaign duration ([See Campaign Report ↗](/documentation/campaign-management/reports/overview)).
            </Info>
