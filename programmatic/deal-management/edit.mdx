...
<Steps>
    ...
    ![Accessing the Create New Deal Page 1](/images/programmatic/deal-management/edit/edit-deal-1.png)

    This will display the selected **Deal Details Page.**

    ![Accessing the Create New Deal Page 1.2](/images/programmatic/deal-management/edit/edit-deal-1.2.png)

    </Step>
    <Step title="Click 'Save Changes' Button">
    Once you have finished making changes, press the **Save** button to save the changed data.
    
    ![Accessing the Create New Deal Page 1](/images/programmatic/deal-management/edit/edit-deal-2.png)
